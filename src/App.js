import { Button, Card, CardTitle, Row, Col, MediaBox, Slider, Slide, Caption, SideNav, SideNavItem, Icon } from "react-materialize";

function App() {
  return (
    <div>
      <SideNav
        trigger={<Button style={{marginBottom: "10px"}}><Icon>menu</Icon></Button>}
      ...
      >
        <SideNavItem userView
          ...
          <SideNavItem href="#" icon={<Icon>perm_identity</Icon>} >Profil Saya </SideNavItem>
          <SideNavItem href="#" icon={<Icon>help</Icon>}>Hubungi Kami</SideNavItem>
          <SideNavItem divider/>
      ...
      <Slider>
        <Slide image={<img src='https://s-ec.bstatic.com/images/hotel/max1024x768/106/106114417.jpg'/>}>
          <Caption placement="center">
            <h3>Pantai</h3>
            <h5>Dapatkan Kesempatan Jalan - Jalan Ke Pantai Dengan Membeli Product</h5>
          </Caption>
        </Slide>
        ...
        <Slide image={<img src='https://photos.mandarinoriental.com/is/image/MandarinOriental/paris-2017-home?wid=2880&hei=1280&fmt=jpeg&crop=9,336,2699,1200&anchor=1358,936&qlt=75,0&fit=wrap&op_sharpen=0&resMode=sharp2&op_usm=0,0,0,0&iccEmbed=0&printRes=72'/>}>
          <Caption placement="center">
            <h3>Paris</h3>
            <h5>Dapatkan Kesempatan Jalan - Jalan Ke Paris Dengan Membeli Product</h5>
          </Caption>
        </Slide>
      </Slider>
      <Row>
        ...
        <Col m="3">
          ...
          >
            Audio Technica - Mulai Dari <span style={{backgroundColor: "#db3f18"}}>Rp 910 rb</span>
          </Card>
        </Col>
        <Col m="3">
          <Card
          ...
          >
            <p style={{fontSize: "14px"}}>Handphone Samsung - Mulai Dari <span style={{backgroundColor: "#db3f18"}}>Rp 200 rb</span></p>
          </Card>
        </Col>
        <Col m="3">
          <Card
          ...
          >
            Sequishy - Mulai Dari <span style={{backgroundColor: "#db3f18"}}>Rp 5,5 rb</span>
          </Card>
        </Col>
        <Col m="3">
          <Card
          ...
          >
            Koleksi The Avenger - Mulai Dari <span style={{backgroundColor: "#db3f18"}}>Rp 10 rb</span>
          </Card>
        </Col>
      </Row>
